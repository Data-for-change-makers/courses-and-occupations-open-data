...
Contributors engage with the project through the issue tracker
...
Membership of the PMC is by invitation from the existing
...
In order to ensure that the project is not bogged down 
